...
[![Build
Status](https://travis-ci.org/ethereum/chorus.png?branch=master)](https://travis-ci.org/ethereum/chorus)

The common package contains the ethereum utility library.

# Installation

As a subdirectory the main chorus repository, you get it with
`go get github.com/Baptist-Publication/chorus-module/lib/eth`.
